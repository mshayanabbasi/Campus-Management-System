...
import com.campussystem.StudentFragments.StudentCompanyFragment;
import com.campussystem.StudentFragments.StudentProfileFragment;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position)
            {
                ...
                case 1:
                    StudentCompanyFragment companyStudentFragment=new StudentCompanyFragment();
                    return companyStudentFragment;
             /*   case 2:
                    NewJobs studentJobList=new NewJobs();
